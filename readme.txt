...
(I am aware I could have just used an Object instead of chopsticks)
...
The philosophers all try to take their left chopstick 
If this were the case, there could be a circular wait condition, but one of the philosophers rejects the idea of left and right and reaches for his "right" chopstick first
